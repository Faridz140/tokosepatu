		...
		<div class="rows">
			<form method="POST" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<input type="text" name="toko" class="form-control" value="<?php echo $pecah['namatoko'];?>">
				</div>
				<div class="form-group">
					<label>Alamat</label>
...
if (isset($_POST['ubah'])) {
	...
	if (!empty($lokasi_foto)) {
		...
		$koneksi->query("UPDATE produk SET nama_produk='$_POST[nama]',kategori='$_POST[kategori]',harga_produk='$_POST[harga]',berat='$_POST[berat]',stok_produk='$_POST[stok]',foto_produk='$nama_foto',deskripsi_produk='$_POST[deskripsi]',namatoko='$_POST[toko]',alamat='$_POST[alamat]' WHERE id_produk='$_GET[id]'");
	}else{
