...
<head>
  ...
  <title>Admin Page Shoes store</title>
  <!-- BOOTSTRAP STYLES-->
...
<body>
  <div id="wrapper">
    <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
      ...
      float: right;
      font-size: 16px;">Last access :26 Maret 2019 &nbsp;
    ...
    <nav class="navbar-default navbar-side" role="navigation">
      <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
          ...
          <li><a href="index.php?halaman=metodekirim"><i class="fa fa-file "></i> Metode Kirim</a></li>
    ...
    <div id="page-wrapper" >
      <div id="page-inner">
        ...
        if (isset($_GET['halaman'])) {
          ...
          }else if ($_GET['halaman']=='editpelanggan') {
